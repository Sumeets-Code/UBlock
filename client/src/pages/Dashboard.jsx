...
function DashboardPage({ setPage }) {
  ...
  return (
    ...
    //     {[
    //       { label: "Total Evidence", value: STATS.total, sub: "Items in vault", cls: "" },
    ...
    //       {[
    //         { cat: "image", icon: "🖼️", label: "Images" },
    //         { cat: "document", icon: "📄", label: "Documents" },
    //         { cat: "audio", icon: "🎵", label: "Audio" },
    //         { cat: "video", icon: "🎬", label: "Video" },
    ...
    //               <span style={{ fontSize: 13, display: "flex", alignItems: "center", gap: 8 }}>{icon} {label}</span>
