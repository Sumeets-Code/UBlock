...
function UploadPage({ setPage }) {
  ...
  const { registerEvidenceOnChain, txHash, txStatus, txError, gasCost, reset } =
    useBlockchain();
    ...
    <div>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 14 }}>
          Upload evidence to IPFS and register it immutably on Ethereum. Choose
        ...
        >
          ...
          <div className="card">
            ...
            <div className="form-group">
              ...
              <input
                className="form-control"
                placeholder="e.g., 123 Main St, Scene B, Room 4"
                value={form.location}
            ...
            <div className="form-group">
              ...
              <input
                className="form-control"
                placeholder="weapon, fingerprint, digital"
                value={form.tags}
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                >
                  ...
                  >
                    You pay ~$0.002 gas. Your wallet address is permanently
                    recorded as uploader.
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    Operator wallet pays gas. Your officer name is recorded. No
                    MetaMask needed.
                  </div>
                </div>
              </div>
            ...
            >
              ⚡ All uploads are pinned to IPFS and the SHA-256 hash is
              registered immutably on Ethereum regardless of who pays gas.
            </div>
          </div>
        </div>
      )}
      ...
      {uiStep === "signing" && ipfsData && (
        <div className="card" style={{ maxWidth: 560, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ color: "var(--text-muted)", fontSize: 14 }}>
              Your file is pinned on IPFS. Approve the transaction to register
              it permanently on Ethereum.
            </div>
          </div>
