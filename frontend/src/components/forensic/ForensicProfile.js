...
const ForensicProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            const mockData = {
                name: "John Doe",
                email: "john.doe@forensics.gov",
                phone: "+91 98765 43210",
                rank: "Senior Forensic Analyst",
                department: "Cybercrime Investigation Unit",
                employeeId: "FZC-2048",
                address: "123 Defense Colony, Sector 45, New Delhi, India",
                dateOfJoining: "12 January 2020",
                profilePic: null
            };
            setProfile(mockData);
        };
        ...
        <div className={styles.container}>
            ...
            <section className={styles.profileSection}>
                ...
                <div className={styles.buttonGroup}>
                    <Link to="/forensic/manage-evidence" className={styles.manageBtn}>Manage Logs</Link>
                    <Link to="/forensic/change-password" className={styles.changeBtn}>Change Password</Link>
                    <Link to="/forensic/update-profile" className={styles.updateBtn}>Update Profile</Link>
